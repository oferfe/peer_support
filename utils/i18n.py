...
TRANSLATIONS: dict[str, dict[str, str]] = {
    LANG_EN: {
        ...
        "save_changes_noop_toast": "No biography or intake changes detected.",
    ...
    LANG_HE: {
        ...
        "save_changes_noop_toast": "לא זוהו שינויים בביוגרפיה או בשאלון הקליטה.",
        ...
        "intake_form_caption": ( "ניתן לענות על שאלון הקליטה באופן ידני או על ידי לחיצה על מילוי אקראי."
        "לאחר סיום מילוי השאלון, יש ללחוץ על כפתור יצירת ביוגרפיה."
        ),
